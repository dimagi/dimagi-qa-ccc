# Mirrored verbatim from dimagi-qa-commcare-mobile (branch kb/commcare-mobile-tests,
# scripts/hq_client.py) by Kankana Bordoloi. Kept identical so the two repos can be
# kept in sync / de-duplicated later. Used here to resolve the Personal ID app's
# install code at runtime instead of hardcoding it.
"""
